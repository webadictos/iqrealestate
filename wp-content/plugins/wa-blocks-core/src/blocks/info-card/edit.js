...
export default function Edit(props) {
  ...
  const changeLegendContent = changes => {
    setAttributes({
      legend: changes,
    });
  };
        ...
        <div className="wp-block-wa-blocks-core-info-card__container">
          <ul className="wp-block-wa-blocks-core-info-card__info">
            <li>
              ...
              <PlainText
                className="wp-block-wa-blocks-core-info-card__address"
                placeholder="Escribe la dirección del lugar"
            ...
            <li>
              ...
              <PlainText
                className="wp-block-wa-blocks-core-info-card__phone"
            ...
            <li>
              ...
              <PlainText
                className="wp-block-wa-blocks-core-info-card__whatsapp"
            ...
            <li>
              ...
              <URLInput
                className="wp-block-wa-blocks-core-info-card__url"
                value={attributes.web}
                onChange={value => setAttributes({ web: value })}
              />
            </li>
            ...
            <li className="wp-block-wa-blocks-core-info-card__social-networks">
              ...
              <URLInput
                className="wp-block-wa-blocks-core-info-card__social wp-block-wa-blocks-core-info-card__social--facebook"
              ...
              <URLInput
                className="wp-block-wa-blocks-core-info-card__social wp-block-wa-blocks-core-info-card__social--instagram"
              ...
              <URLInput
                className="wp-block-wa-blocks-core-info-card__social wp-block-wa-blocks-core-info-card__social--twitter"
