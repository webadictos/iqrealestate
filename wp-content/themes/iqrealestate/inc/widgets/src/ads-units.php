...
class WA_Widget_Adunit extends WP_Widget
{
	...
	public function widget($args, $instance)
	{
		...
		if ($slot) {
			...
			if (is_array($_slot)) {
				wa_create_ad_slot($_slot, $insertion);
			}
	...
	public function update($new_instance, $old_instance)
	{
		...
		$instance['slot_class'] 	= $new_instance['slot_class'];
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('slot_class'); ?>"><?php _e('Clase CSS del slot:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('slot_class'); ?>" name="<?php echo $this->get_field_name('slot_class'); ?>" type="text" value="<?php echo esc_attr($instance['slot_class']); ?>" />
		</p>
