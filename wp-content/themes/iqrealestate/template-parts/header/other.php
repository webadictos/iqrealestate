    ...
    <div class="container">
        <div class="row w-100 g-0 justify-content-center">
            <div class="col-12 col-lg-6 d-flex justify-content-md-center">
                ...
                <button class="navbar-toggler ms-auto p-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'wa-theme'); ?>">
                            ...
                            <div class="navbar-searchform">
                                <form class="search-form my-2 my-lg-0" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="s" class="form-control" placeholder="<?php esc_attr_e('Search', 'wa-theme'); ?>" title="<?php esc_attr_e('Search', 'wa-theme'); ?>" />
                                    </div>
