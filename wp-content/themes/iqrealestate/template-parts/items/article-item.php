    ...
    <article <?php post_class("article-item " . $itemArgs['items_layout_css'], get_the_ID()); ?> <?php function_exists('wa_article_item_attributes') ? wa_article_item_attributes() : ''; ?>>
        ...
        <header class="article-item__header">
            ...
            <div class="article-item__meta">
                ...
                <?php if ($itemArgs['items_config']['items_show_main_cat'] && isset($primary_category['primary_category'])) : ?>

                    <a class="article-item__cat post-category" href="<?php echo get_category_link($primary_category['primary_category']->term_id); ?>"><?php echo $primary_category['primary_category']->name; ?></a>

                <?php endif; ?>

                <?php if ($itemArgs['items_config']['items_show_parent_cat'] && isset($primary_category['parent_category'])) : ?>
                ...
                <?php if ($itemArgs['items_config']['items_show_author']) : ?>
                    ...
                    <div class="article-item_author" itemprop="author" itemscope itemtype="http://schema.org/Person">
                        ...
                        <?php if ($itemArgs['items_config']['items_show_date']) : ?>
                            <time class="article-item__time" datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?php the_time(); ?></time>
                        <?php endif; ?>
                    </div>
