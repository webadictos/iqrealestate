...
$_layoutArgs = array(
    ...
    'items_layout' => 'iq_realestate-item',
    'items_layout_css' => '',
    'items_swiper' => false,
    'exclude_ids' => false,
    'dont_exclude' => false,
            ...
            ?>
                ...
                <?php if ($layoutArgs['show_section_title']) : ?>
                    ...
                    <header class="section__title-container <?php echo $layoutArgs['section_title_container_class']; ?>">
                        ...
                        if ($layoutArgs['section_link'] !== "") :
                        ?>
                            <a class="section__title-more" href="<?php echo $layoutArgs['section_link']; ?>" title="<?php echo $layoutArgs['section_link_title']; ?>"><?php echo $layoutArgs['section_link_title']; ?></a>
                        <?php endif; ?>
                    </header>
