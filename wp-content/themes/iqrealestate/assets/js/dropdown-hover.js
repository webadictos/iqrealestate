...
if (!isMobile()) {
  ...
  dropdownItems.forEach(function (everyitem) {
    ...
    let viewAllTemplate = `
        <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" class="menu-item"><a title="Ver todos" href="${url}" class="dropdown-item view-all-link">Ver todos</a></li>
        `;
