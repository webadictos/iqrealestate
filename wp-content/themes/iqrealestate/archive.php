			...
			<section class="section p-0">
				...
				<header class="section__title-container page-header">
					...
					<h1 class="section__title page-title">
						<?php
						if (is_day()) :
							printf(esc_html__('Daily Archives: %s', 'wa-theme'), get_the_date());
						elseif (is_month()) :
							printf(esc_html__('Monthly Archives: %s', 'wa-theme'), get_the_date(_x('F Y', 'monthly archives date format', 'wa-theme')));
						elseif (is_year()) :
							printf(esc_html__('Yearly Archives: %s', 'wa-theme'), get_the_date(_x('Y', 'yearly archives date format', 'wa-theme')));
						else :
							esc_html_e('Blog Archives', 'wa-theme');
						endif;
						?>
					</h1>
